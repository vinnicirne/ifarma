        ...
        <div className="bg-background-light dark:bg-[#102218] text-white font-display min-h-screen flex flex-col transition-colors duration-200" style={confirmTheme}>
                ...
                <div className="p-4">
                    <div className="bg-slate-200 dark:bg-white/5 rounded-xl p-4 border border-gray-300 dark:border-white/10">
                        <div className="flex justify-between items-start mb-2">
                            <span className="text-xs font-semibold uppercase tracking-wider text-[#13ec6d]">Pedido #4829</span>
                            <span className="text-xs text-slate-500 dark:text-gray-400">Há 15 min</span>
                        </div>
                        <h3 className="text-lg font-bold text-slate-900 dark:text-white">Carlos Eduardo Silva</h3>
                        <p className="text-sm text-slate-500 dark:text-gray-400 mt-1">Rua das Flores, 123 - Apt 402</p>
                    </div>
                </div>

                {/* Section: Proof (Optional) */}
                <div className="px-4 py-2">
                    <h3 className="text-slate-900 dark:text-white text-lg font-bold leading-tight tracking-tight mb-4">Comprovação (Opcional)</h3>
                    <div className="flex flex-col">
                        <div className="flex flex-col items-center gap-4 rounded-xl border-2 border-dashed border-[#13ec6d]/30 bg-[#13ec6d]/5 px-6 py-10 transition-all hover:bg-[#13ec6d]/10 cursor-pointer">
                            ...
                            <button className="flex min-w-[140px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-10 px-6 bg-[#13ec6d] text-[#102218] text-sm font-bold leading-normal tracking-wide hover:bg-[#13ec6d]/90 active:scale-95 transition-all">
            ...
            <footer className="fixed bottom-0 left-0 right-0 p-4 bg-background-light/95 dark:bg-[#102218]/95 backdrop-blur-md pb-8 border-t border-gray-200 dark:border-white/5">
                <button
                    ...
                    className="w-full bg-[#13ec6d] hover:bg-[#13ec6d]/90 text-[#102218] font-bold py-4 rounded-xl text-lg shadow-lg shadow-[#13ec6d]/20 flex items-center justify-center gap-2 transition-transform active:scale-[0.98]"
                >
